...
Now you might think. Nice, but I would like to have other folders inside because I'm used to another way to sort my data. Be assured, you can adopt our standard-scheme to your specific needs. There are even two ways to adopt it.
1. You can add templates to your standard-folders. Like i.e. financial templates, technical development templates, templates for Klienten oder Patienten.
...
So hopefully your take away of this lesson is, that our standard folders come with a deep structure of subfolders behind which we call a 'Template' and that you can change it to your liking.
